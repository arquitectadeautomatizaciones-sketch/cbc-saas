              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <input style={{ ...inputStyle, flex: 1 }} value={prospecto.nombre} onChange={(e) => setProspecto({ ...prospecto, nombre: e.target.value })} />
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <input style={{ ...inputStyle, flex: 1 }} value={prospecto.empresa} onChange={(e) => setProspecto({ ...prospecto, empresa: e.target.value })} />
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
                    <textarea
                      style={{ ...inputStyle, flex: 1, height: 80, resize: 'none' } as React.CSSProperties}
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <input style={{ ...inputStyle, flex: 1 }} value={prospecto.promesa} onChange={(e) => setProspecto({ ...prospecto, promesa: e.target.value })} />
